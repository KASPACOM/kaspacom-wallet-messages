export enum EIP1193RequestType {
...
export interface EIP1193RequestParams {
  ...
  [EIP1193RequestType.GET_CODE]: [string, string]; // [address, blockNumber]
  ...
  [EIP1193RequestType.GET_TRANSACTION_COUNT]: [string, string]; // [address, blockNumber]
  [EIP1193RequestType.GET_TRANSACTION_RECEIPT]: [string]; // [transactionHash]
  [EIP1193RequestType.GET_TRANSACTION_BY_HASH]: [string]; // [transactionHash]
  [EIP1193RequestType.GET_BLOCK_BY_NUMBER]: [string, boolean]; // [blockNumber, includeTransactions]
  [EIP1193RequestType.GET_BLOCK_BY_HASH]: [string, boolean]; // [blockHash, includeTransactions]
  ...
  [EIP1193RequestType.PERSONAL_SIGN]: [string, string]; // [message, address]
  [EIP1193RequestType.SIGN_TYPED_DATA]: [string, string]; // [address, typedData]
  [EIP1193RequestType.SIGN_TYPED_DATA_V4]: [string, string]; // [address, typedData]
  ...
  [EIP1193RequestType.WALLET_SWITCH_ETHEREUM_CHAIN]: [{ chainId: string }];
